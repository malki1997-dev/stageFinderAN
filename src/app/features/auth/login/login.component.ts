...
if (!decoded || !decoded.role || !decoded.id) {
  ...
  return;
        ...
        console.log("Rôle dans le token :", role);
...
if (role === 'ADMINISTRATEUR') this.router.navigate(['']);
else if (role === 'RECRUTEUR') this.router.navigate(['']); // redirection vers offres
else if (role === 'STAGIAIRE') this.router.navigate(['']); // redirection vers postuler
